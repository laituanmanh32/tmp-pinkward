...
public class WaveSurfing extends Operator {
	...
	public void onPaint(java.awt.Graphics2D g) {
		...
		for (int i = 0; i < _enemyWaves.size(); i++) {
			...
			// hack to make waves line up visually, due to execution sequence in
			// robocode engine
			// use this only if you advance waves in the event handlers (eg. in
			// onScannedRobot())
			// NB! above hack is now only necessary for robocode versions before
			// 1.4.2
			// otherwise use:
